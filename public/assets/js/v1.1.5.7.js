function openTOS() {
	...
	$("#popup-modal")
	  .html(n)
	  .modal({ closeClass: "icon-minutes", closeText: " " });
  }
  ...
  function randomString(n, t) {
	...
	for (
	  ...
	  (u = Math.floor(Math.random() * t.length)), (i += t.substring(u, u + 1));
	return i;
  }
  function fixHeight() {
  ...
  function HideReview(n, t) {
	confirm("Bạn có muốn ẩn đánh giá này!") &&
	  $.post("/api/review/hide", { id: n }, function (n) {
		if (n.Errors)
		  $.toast({
  ...
  function RemoveReview(n, t) {
	confirm("Bạn có muốn xóa đánh giá này!") &&
	  $.post("/api/review/remove", { id: n }, function (n) {
		if (n.Errors)
		  $.toast({
			heading: "Có lỗi xảy ra.",
			text: n.Title,
  ...
  function HideComment(n, t) {
	confirm("Bạn có muốn ẩn bình luận này!") &&
	  $.post("/api/comment/hide", { id: n }, function (n) {
		if (n.Errors)
		  $.toast({
			heading: "Có lỗi xảy ra.",
			text: n.Title,
  ...
  function RemoveComment(n, t) {
	confirm("Bạn có muốn xóa bình luận này!") &&
	  $.post("/api/comment/remove", { id: n }, function (n) {
		if (n.Errors)
		  $.toast({
			heading: "Có lỗi xảy ra.",
			text: n.Title,
  ...
  function init_Review() {
	...
	$(".rating").on("change", function (i, r) {
	  ...
	  u == ""
		? ($(t).find("input[name=Rate]").val(r.to),
		  (n = $(t).serializeObject()),
	...
	for (var t in e) {
	  ...
	  c && u == ""
		...
		: f != "" &&
		  ...
		  parseInt(f) > u.length &&
		  u != "" &&
		  (r += i + " Cần nhập tối thiêu " + f + " ký tự<br />");
	  r != ""
		? ($(n)
			.find("*[name=" + t + "]")
			.addClass("errors"),
  ...
  function submitSubscription(n) {
	...
	return (
	  validateEmail(t)
		? $.post("/Ajax/AddSubScription", $(n).serialize(), function (t) {
			t.Errors
			  ? $.toast({ heading: "Lỗi", text: t.Message, icon: "error" })
			  : ($.toast({
  ...
  function autoComplateFormat(n) {
	var t =
	  '<div class="search-item" onclick="location.href=\'' + n.data.uid + "'\">";
	return (
	  (t += '<div class="img"><img src="' + n.data.image + '" /></a></div>'),
	  (t += '   <div class="info">'),
	  (t +=
		'       <h2><a href="' + n.data.uid + '">' + n.data.title + "</a></h2>"),
	  (t +=
		"       <h3><strike>" +
		n.data.lastprice +
		"</strike> " +
	...
	return (
	  i != "" || r
		...
		: ((postValue = $(t).serializeObject()),
		  $("#installmentForm button[type=submit]")
		  ...
		  $.post("/api/cart/installmentOrder", postValue, function (n) {
			if (n.Errors)
			  ...
			  var t =
				'<p style="text-align:center; font-size:20px;">Cám ơn bạn đã gửi yêu cầu đăng ký mua trả góp. Mã đơn hàng đăng ký trả góp của bạn là <a href="/order/installment/' +
				n.Title +
				'"><strong>' +
				n.Title +
				"</strong></a></p>";
	...
	$(".cart-paymentTypeId").click(function () {
	  ...
	  n == 1
		? ($("#payType_1").addClass("payment-selected"),
		  $("#f_payType_1").show(),
		  $("#f_payType_5").hide(),
		  $("#SystemCityID, #SystemDistrictID, #Address").attr(
			"data-required",
			1
		  ),
		...
		: ($("#payType_5").addClass("payment-selected"),
		  ...
		  $("#SystemCityID, #SystemDistrictID, #Address").removeAttr(
			"data-required"
		  ));
	  $("#SystemCityID").change();
	  $("#MKSystemCityID").change();
  ...
  function wishProduct(n, t) {
	...
	t
	  ? $.post("/api/account/wish", { ID: n }, function (n) {
		  n.Errors || $(".love-this-button a").toggleClass("inlist");
		  i +=
			'<p><i class="icon-checked text-red"></i> <span>' +
			n.Title +
			"</span></p>";
		  i +=
	  ...
	  : ((i +=
		  '<p><i class="icon-minutes text-red"></i> <span>Bạn cần đăng nhập để sử dụng chức năng này</span></p>'),
		(i +=
		  '<a class="button button-red" href="/account/login">Đăng nhập/Đăng ký</a>'),
		(i += "</div>"),
		$.toast({
		  text: i,
		  position: "bottom-center",
  ...
  function validFormQuickOrder_v2(n) {
	...
	return (
	  u == null || u == ""
		? ((t += "Bạn cần tích chọn xác thực không phải người máy."),
	  ...
	  r != "" || u
		...
		: ((t = []),
		  ...
		  grecaptcha.ready(function () {
			grecaptcha
			  .execute(RECAPTCHA_API_KEY, { action: "order" })
			  .then(function (n) {
  ...
  function cartPlus(n) {
	var t = cartGetCookie(),
	  i = t.findIndex((t) => t.sku == n);
	i >= 0 &&
	  (t[i].number++, $.cookie("_cart", JSON.stringify(t), { path: "/" }));
	cartReload();
  }
  function cartChange() {
	cartReload();
  ...
  function cartDelete(n) {
	var t = cartGetCookie(),
	  i = t.findIndex((t) => t.sku == n);
	i >= 0 &&
	  (t.splice(i, 1), $.cookie("_cart", JSON.stringify(t), { path: "/" }));
	cartReload();
  }
  function cartEdit() {
	cartReload();
  ...
  function btnInstallment() {
	$(".btnInstallment").click(function () {
	  var n =
		$(".btnInstallment").hasClass("disabled") ||
		$(".btnQuickOrder").hasClass("btn-outstock");
	  if (n) return !1;
	});
  }
  function AddCart() {
		...
		if (!s) {
		  ...
		  u.forEach(function (n) {
			if (t) {
			  ...
			  r &&
				e != "-1" &&
				(i = t.findIndex((t) => t.sku == n && t.color == r));
			  i >= 0
				? t[i].number++
				: (t.push({ sku: n, number: 1, color: e ? e : r }),
		  ...
		  i +=
			'<p><i class="icon-checked"></i> <span>Thêm giỏ hàng thành công</span></p>';
		  i +=
			'<a class="button" href="/gio-hang">Xem giỏ hàng và thanh toán</a>';
		  i += "</div>";
		  $.toast({
			text: i,
			position: "bottom-center",
  ...
  function outStockMessage() {
	...
	t || i
	  ? i && !t
		? ($("p.out-noonline").show(), $("p.out-stock").hide())
		: t && ($("p.out-stock").show(), $("p.out-noonline").hide())
	  : ($("p.out-stock").hide(), $("p.out-noonline").hide());
	$(".product-action .btnbuy").removeClass("btn-outstock");
	n > 0
	  ? $("#stock-sum").html(
		  "<label>Có <strong>" + n + "</strong> cửa hàng còn sản phẩm</label>"
		)
	  : $("#stock-sum").html("");
  }
  ...
  function scrollTo(n) {
	$("html, body").animate({ scrollTop: $(n).offset().top - 50 }, 500);
  }
	...
	window.jssor_1_slider_init = function () {
	  function n() {
		var f = t.$Elmt.parentNode,
		  ...
		  u;
		i
		  ? ((u = Math.min(r || i, i)), t.$ScaleWidth(u))
		  : window.setTimeout(n, 30);
	  }
	  var i = {
  ...
  function quickOrder() {
	$(".btnQuickOrder").click(function (n) {
	  var u =
		$(".btnQuickOrder").hasClass("disabled") ||
		$(".btnQuickOrder").hasClass("btn-outstock");
	  if (!u) {
	...
	$(".btnQuickRefOrder").click(function (n) {
	  var u =
		$(".btnQuickRefOrder").hasClass("disabled") ||
		$(".btnQuickRefOrder").hasClass("btn-outstock");
	  if (!u) {
		var t = $(this).attr("data-sku"),
		  i = $("#colorOptions .selected").attr("data-id"),
	...
	(function (n) {
	  ...
	  n.ScrollToFixed = function (t, i) {
		...
		function a() {
		  ...
		  if (n.isScrollToFixed(r) && !r.is(":hidden")) {
			...
			var s = n(window).scrollLeft(),
			  ...
			  i = nt();
			u.options.minWidth && n(window).width() < u.options.minWidth
			  ? (e() && t) ||
				(o(),
				r.trigger("preUnfixed.ScrollToFixed"),
				f(),
				r.trigger("unfixed.ScrollToFixed"))
			  : u.options.maxWidth && n(window).width() > u.options.maxWidth
			  ? (e() && t) ||
				(o(),
				r.trigger("preUnfixed.ScrollToFixed"),
				f(),
			  ...
			  ? i > 0 && h >= i - y()
				...
				: (e() && t) ||
				  ...
				  r.trigger("unfixed.ScrollToFixed"))
			  : i > 0
			  ? h + n(window).height() - r.outerHeight(!0) >= i - (y() || -st())
				? l() &&
				  (o(),
				  r.trigger("preUnfixed.ScrollToFixed"),
				  d === "absolute" ? it() : f(),
				  r.trigger("unfixed.ScrollToFixed"))
				: (l() || (o(), r.trigger("preFixed.ScrollToFixed"), b()),
				  k(s),
				  r.trigger("fixed.ScrollToFixed"))
			  : k(s);
		  }
		...
		function o() {
		  ...
		  n == "absolute"
			? r.trigger("postAbsolute.ScrollToFixed")
			: n == "fixed"
			? r.trigger("postFixed.ScrollToFixed")
			: r.trigger("postUnfixed.ScrollToFixed");
		}
		var u = this;
		u.$el = n(t);
		u.el = t;
		...
		var p = !1,
		  ...
		  lt = function () {
			var n = document.body,
			  ...
			  u,
			  f;
			return document.createElement && n && n.appendChild && n.removeChild
			  ? ((t = document.createElement("div")), !t.getBoundingClientRect)
				? null
				: ((t.innerHTML = "x"),
		...
		u.init = function () {
		  ...
		  u.options.preFixed &&
			r.bind("preFixed.ScrollToFixed", u.options.preFixed);
		  u.options.postFixed &&
			r.bind("postFixed.ScrollToFixed", u.options.postFixed);
		  u.options.preUnfixed &&
			r.bind("preUnfixed.ScrollToFixed", u.options.preUnfixed);
		  u.options.postUnfixed &&
			r.bind("postUnfixed.ScrollToFixed", u.options.postUnfixed);
		  u.options.preAbsolute &&
			r.bind("preAbsolute.ScrollToFixed", u.options.preAbsolute);
		  u.options.postAbsolute &&
			r.bind("postAbsolute.ScrollToFixed", u.options.postAbsolute);
  ...
  !(function (n, t, i, r, u, f, e) {
	...
	function nt(n, t, i) {
	  ...
	  f.$Scale = function (n, t, i) {
		(n != 1 || t != 1 || i != 1) &&
		  (u = o([n, 0, 0, 0, 0, t, 0, 0, 0, 0, i, 0, 0, 0, 0, 1]));
	  };
	  ...
	  t.T = function (n, t, i, u) {
		o.f(r, function (f, e) {
		  f.Ne === n &&
			...
			f.gc === i &&
			f.Xe == u &&
			(o.$RemoveEvent(n, t, i, u), r.splice(e, 1));
		});
	  };
	  t.Ve = e;
	...
	h = n.$Jease$ = {
	  ...
	  $InElastic: function (n) {
		if (!n || n == 1) return n;
		return -(s.B(2, 10 * (n -= 1)) * s.gb(((n - 0.075) * 2 * s.u) / 0.3));
	  },
	  $OutElastic: function (n) {
		if (!n || n == 1) return n;
		return s.B(2, -10 * n) * s.gb(((n - 0.075) * 2 * s.u) / 0.3) + 1;
	  },
	  $InOutElastic: function (n) {
		...
		var t = 0.45,
		  i = 0.1125;
		return (n *= 2) < 1
		  ? -0.5 * s.B(2, 10 * (n -= 1)) * s.gb(((n - i) * 2 * s.u) / t)
		  : s.B(2, -10 * (n -= 1)) * s.gb(((n - i) * 2 * s.u) / t) * 0.5 + 1;
	  },
	  $InBack: function (n) {
		var t = 1.70158;
		return n * n * ((t + 1) * n - t);
	  ...
	  $InOutBack: function (n) {
		var t = 1.70158;
		return (n *= 2) < 1
		  ? (1 / 2) * n * n * (((t *= 1.525) + 1) * n - t)
		  : (1 / 2) * ((n -= 2) * n * (((t *= 1.525) + 1) * n + t) + 2);
	  },
	  $InBounce: function (n) {
	...
	o = n.$Jssor$ = new (function () {
	  ...
	  function er() {
		if (!yt) {
		  ...
		  var i;
		  (pt.pointerEnabled || (i = pt.msPointerEnabled)) &&
			(yt.re = i ? "msTouchAction" : "touchAction");
		}
		return yt;
	  }
	  function wt(t) {
		...
		if (!w)
		  if (
			((w = -1),
			ci != "Microsoft Internet Explorer" ||
			  !n.attachEvent ||
			  !n.ActiveXObject)
		  )
			if (ci != "Netscape" || !n.addEventListener)
			  ...
			  var f = tt(v, "Firefox"),
				...
				e = tt(v, "AppleWebKit");
			  f >= 0
				? ((w = ur), (b = k(v.substring(f + 8))))
				: u >= 0
				? ((o = v.substring(0, u).lastIndexOf("/")),
				  (w = s >= 0 ? fr : oi),
				  (b = k(v.substring(o + 1, u))))
				: ((i = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/i.exec(v)),
				  i && ((w = vt), (b = k(i[1]))));
	  ...
	  function cr(n) {
		...
		return function (i) {
		  if (!t) {
			...
			t =
			  c(["", "WebKit", "ms", "Moz", "O", "webkit"], function (t) {
				var u = t + (t ? r : n);
	  ...
	  function c(n, t) {
		var i, r;
		if (bt(n)) {
		  for (i = 0; i < a(n); i++) if ((r = t(n[i], i, n))) return r;
		} else for (i in n) if ((r = t(n[i], i, n))) return r;
	  }
	  function kt(n) {
	  ...
	  function rt(n) {
		try {
		  return (
			...
			n != n.window &&
			(!n.constructor ||
			  {}.hasOwnProperty.call(n.constructor.prototype, "isPrototypeOf"))
		  );
		} catch (t) {}
	  }
	  function vr(n, t) {
	  ...
	  function ut(t, i, u) {
		if (u !== e) t.style[i] = u == e ? "" : u;
		  ...
		  return (
			...
			u == "" &&
			  n.getComputedStyle &&
			  ((f = t.ownerDocument.defaultView.getComputedStyle(t, r)),
	  ...
	  function wi(n, t, i, u) {
		var f, e;
		for (u = u || "u", f = [], n = n ? n.firstChild : r; n; n = n.nextSibling)
		  n.nodeType == 1 &&
			(ct(n, u) == t && f.push(n),
			i || ((e = wi(n, t, i, u)), a(e) && (f = f.concat(e))));
		return f;
	  }
	  function g() {
		for (
	  ...
	  function dr(n, t, r, u) {
		...
		return (
		  ...
		  (o = {}),
		  (!st() || t) && ((o.tZ = i.Kc), (o.tX = i.Kc), (o.tY = i.Kc)),
		  (st() || t) && ((o.x = a), (o.y = v)),
		  c(n, function (n, t) {
			(o[t] || l)(t);
		  }),
	  ...
	  function gi(n, t) {
		var r = [],
		  ...
		  f,
		  h;
		for (t & 2 && (e = !e), o = s.H(n / 2), i = 0; i < n; i++)
		  (u = i),
			t & 4
			  ? ((f = s.G(s.dd() * n)),
				(u = p(r[i], i)),
	  ...
	  function nu(n, t, r) {
		...
		function ut(n, t) {
		  for (var u = 0, f = 0, i = 0, r = t ? 6 : 0; r < a(n); r += 6)
			(u += n[r]), (f += n[r + 1]), i++;
		  return { x: i ? u / i : e, y: i ? f / i : e };
		}
		function u(n) {
		  function r(t) {
			return { x: n[t], y: n[t + 1] };
		  }
		  function o(n, t, u) {
			var f = i.Ue(n, t),
			  o,
		  ...
		  for (
			...
			(u = r(t)), o(u, f, t), o(r(t - 2), u, t - 2), o(r(t + 2), u, t + 2);
		  return {
			lb: n,
			qb: (a(n) - 2) / 6,
			kc: f.x,
		...
		function b(n, t) {
		  ...
		  function o(n, t) {
			return (
			  (t = t || 0), s.Y(((n - t + s.u * 101) % (s.u * 2)) - s.u + t, 8)
			);
		  }
		  function c(i, r) {
			var f = n.Vc[i],
		  ...
		  for (
			u = o(y / r),
			  f &&
				((e = f > 0 ? 1 : -1),
				(u =
				  ((u + s.u * 2 * e) % (s.u * 2) || s.u * 2 * e) +
				  s.u * 2 * (f - e))),
			  i = 0;
			i < a(n.lb);
			i += 6
		  )
			(l = c(i, u)), c(i - 2, l), c(i + 2, l);
		  p = gr(r, it);
		  w = gi(r, h.o);
		  t.ad = function (n, i) {
		...
		function k(n, t, i, r, f) {
		  ...
		  if (o < e) {
			for (
			  var d = st(t.lb), g = e / o, y = e - o, l = 0, p = 0;
			  p < 10 && l < y;
			  p++
			)
			  (nt = g + (g * p) / 10),
			...
			c(d, function (n) {
			  for (var t = n.qb, i = n.lb, r; t - 1; )
				(r = rt(i, 1 / t)), v.push(u(r[0])), (i = r[1]), t--;
			  v.push(u(i));
			});
			t = r[f] = ht(v);
		  }
	  ...
	  function tu(n) {
		return g({ wc: i.Ph(n) ? n : h.$Linear }, n);
	  }
		...
		return (
		  c(t, function (t, i) {
			var r = (n && n[i]) || 0,
			  u;
			(at || t !== r) &&
			  ((u = (y && ii[i]) || (rt(t) ? et : ui)), (k[i] = u(r, t, ri(i))));
		  }),
		  (ut = function (n) {
			var t;
			return (
	  ...
	  i.Tc = function (n) {
		return (n = it(n)), { x: n.clientX || 0, y: n.clientY || 0 };
	  };
	  i.Ue = function (n, t) {
	  ...
	  i.kb = function (n, i, r, u) {
		...
		do {
		  if (
			n.nodeType == 1 &&
			(r && (f = ct(n, r)), (f && f == p(i, f)) || u == n.tagName)
		  ) {
			e = n;
			break;
		  }
	  ...
	  i.Ch = function (n) {
		var t = i.bc(),
		  ...
		  r;
		return (
		  at(t, { Me: "block", Pb: i.db(n), $Top: 0, $Left: 0, Eb: 0, Gb: 0 }),
		  (u = i.ve(n, dt)),
		  i.pb(t, n),
		  i.O(t, n),
		  (f = i.ve(n, dt)),
	  ...
	  i.Ce = function (n, t, i, r) {
		var u, e, f, s;
		for (
		  r && (n = ei(n)), u = wi(n, t), a(u) || (u = o.rg(n, t)), e = a(u) - 1;
		  e > -1;
		  e--
		)
		  (f = u[e]),
		...
		function y(n) {
		  ...
		  function v(n, t, i, r, u) {
			...
			var e = h(n, t, i),
			  o = 0;
			return (
			  n.Sd & 2 && ((e = s.H(f / 2) - n.ed), (o = (c(e - 1) / 2) * !n.ed)),
			  {
				Se: function (t) {
		...
		(!ft || g || p != f) &&
		  ...
		  (!ft || g || t != nt) &&
			(d &&
			  ((st = (t - tt) / (i || 1)),
			  (l = d(st)),
			  pt && ((w = t > y && t < v), w != wt && (c = wt = w)),
			  c || l == e || ((b = !l), b != yt && (c = yt = b)),
			  c != e &&
				(c && o.lc(h, "none"), c || o.lc(h, o.g(h, "data-events")))),
			(k = nt),
			(rt = nt = t),
			o.f(ot, function (n, i) {
	...
	d = n.$JssorSlideshowFormations$ = new (function () {
	  ...
	  e.$FormationSwirl = function (e) {
		...
		for (g = 0; g < ot; ) {
		  if (
			((nt = w + "," + s), s >= 0 && s < tt && w >= 0 && w < it && !ut[nt])
		  )
			(ut[nt] = u), f(rt, g++, [w, s]);
		  else
			switch (b[ft++ % o.A(b)]) {
	...
	n.$JssorSlideshowRunner$ = function (n, t, i, e, c, a) {
	  ...
	  function k(n, t) {
		...
		return (
		  ...
		  i.$Brother && ((i.$Brother = k(i.$Brother, t)), (i.$SlideOut = u)),
		  i
		);
	  }
	  function g(n, t, i, r, e, h) {
		...
		return (
		  ...
		  a(t, 0, 0),
		  i.$Reverse || d.reverse(),
		  (v = { x: i.c & 1, t: i.c & 2, y: i.c & 4, m: i.c & 8 }),
		  (k = new l(0, 0)),
		  o.f(d, function (a, nt) {
			g && (nt = o.A(d) - nt - 1);
			var tt = i.$Delay * nt;
			o.f(a, function (a) {
			  ...
			  w &&
				at % 2 &&
				(w & 3 && (nt = !nt), w & 12 && (it = !it), w & 16 && (ut = !ut));
			  b &&
				lt % 2 &&
				(b & 3 && (nt = !nt), b & 12 && (it = !it), b & 16 && (ut = !ut));
			  var ot = it ? v.m : v.y,
				st = it ? v.y : v.m,
				ht = nt ? v.t : v.x,
				ct = nt ? v.x : v.t,
			  ...
			  yt &&
				...
				vt
				  ? ((d = {}),
					(rt = i.$ScaleClip || 1),
					ot && st
					  ? ((d.y = (p.h / 2) * rt), (d.m = -d.y))
					  : ot
					  ? (d.m = -p.h * rt)
					  : st && (d.y = p.h * rt),
					ht && ct
					  ? ((d.x = (p.w / 2) * rt), (d.t = -d.x))
					  : ht
					  ? (d.t = -p.w * rt)
					  : ct && (d.x = p.w * rt),
					i.$Move &&
	...
	n.$JssorArrowNavigator$ = function () {
	  ...
	  n.F = function (r, u, e, h) {
		...
		s = h;
		f.$AutoCenter &&
		  (w.Ac(t, v.yb, f.$AutoCenter), w.Ac(i, v.yb, f.$AutoCenter));
		w.Cc(t);
		w.Cc(i);
	  };
	  n.$Destroy = function () {
	...
	g = n.$JssorCaptionSlideo$ = function () {
	  ...
	  function ti(n, t) {
		...
		if (
		  (ut &&
			((v = ut[o.q(n, "c")]), v && ((i = lt(v.r, 0)), (i.sg = v.e || 0))),
		  (e = o.g(n, "data-to")),
		  e && a && ((e = o.Ud(e)), (e = { x: o.od(e[0]), y: o.od(e[1]) })),
		  (d = {
			$Elmt: n,
			$OriginalWidth: b,
			$OriginalHeight: k,
		  ...
		  o.f(t, function (t) {
			...
			w = s.l(w, t.b + t.d);
			i
			  ? (f || (f = new l(t.b, 0)), f.M(r))
			  : ((c = lt(t.b, t.b + t.d)), c.Zc.push(r));
			h = r.nf();
		  }),
		  i && f)
		) {
		  ...
		  var c = f,
			...
			nt = s.l(g, i.sg);
		  i.ob < g &&
			(i.ob > p ? ((c = new l(p, i.ob - p)), c.M(f, u)) : (c = r),
			(y = new l(i.ob, nt - p, { hc: nt - i.ob, pf: u })),
			y.M(f, u));
		  c && i.Zc.push(c);
		  y && i.Te.push(y);
		}
		...
		o.f(t, function (t) {
		  ...
		  i && f
			? ((r = new g(t, v, { xe: f })),
			  ...
			  n.a(r, p.pc, ci),
			  n.a(r, p.Zb, li))
			: (at(o.jb(t).concat(o.xc(o.Hc(t, "data-tchd"))), i + 1),
	  ...
	  function ii(t, i, r) {
		var e = t.b - i,
		  f;
		return (
		  e && ((f = new l(i, e)), f.M(k, u), f.$Shift(r), n.M(f)), n.qd(t.d), e
		);
	  }
	  function ri(t) {
		var i = k.yc(),
	  ...
	  function ui() {
		ot ||
		  (e & 8 && n.a(t, "keydown", gt),
		  e & 32 && (n.a(t, "mousedown", rt), n.a(t, "touchstart", rt)),
		  (ot = u));
	  }
	  function fi() {
		n.T(t, "keydown", gt);
	  ...
	  function a() {
		!st &&
		  (b || n.z()) &&
		  ((st = u), n.S(), n.Be() > n.qc && n.L(n.qc), n.De(yt || 1), n.tc(0));
	  }
	  function ei() {
		c || a();
	  }
	  ...
	  n.F = function (t, r, f) {
		...
		h &&
		  ...
		  (h & 1 || tt) &&
			!o.ud().td &&
			(n.a(i, "mouseenter", si), n.a(i, "mouseleave", oi)),
		  (vt = o.q(i, "pause")));
		var c = v.$Breaks || [],
		  s = c[o.q(i, "b")] || [],
	...
	c =
	  ...
	  (n.module || {}).exports =
		function () {
			...
			return (
			  !rt ||
				...
				r &&
				  ((i = n - u),
				  t
					? ((i = (s.Xf(i) * 2) / s.u), (i = s.B(i * r, 1.6)))
					: ((i = s.B(i * r, 0.625)), (i = s.Oe((i * s.u) / 2))),
				  (n = u + i * r))),
			  n
			);
		  }
		  ...
		  function ie(n) {
			return !(ft & 1) && n - dt < 0.0001;
		  }
		  function re(n) {
			return !(ft & 1) && ri - n < 0.0001;
		  }
		  function or(n) {
			return !(ft & 1) && (n - dt < 0.0001 || ri - n < 0.0001);
		  }
		  function bu(n, t, i) {
			er ||
			  o.f(si, function (r) {
		  ...
		  function ue(n) {
			var t = n,
			  i = or(n);
			return (
			  i ? (t = uu(t)) : ((n = it(n)), (t = n)), (t = s.G(t)), s.l(t, 0)
			);
		  }
		  function de(n) {
			tt[g];
		  ...
		  function ee(n, t) {
			!w ||
			  (t && ot.$IsPlaying()) ||
			  (ot.S(), (realPosition = te(n)), fi.L(realPosition), fe());
		  }
		  function sr(n) {
			w
			  ? ((n = uu(n)),
		  ...
		  function hr(n, t, i, r) {
			...
			!w ||
			  ...
			  i &&
				((o = c + n),
				ft & 2 &&
				  (ie(c) && n < 0 && (o = ri), re(c) && n > 0 && (o = dt))),
			  ft & 1 || (o = r ? it(o) : uu(o, 0.5)),
			  i && !or(o) && (o = s.$Round(o)),
			  (l = (o - c) % w),
			  (o = c + l),
			  t == e && (t = br),
		  ...
		  function ro(n, t, i) {
			...
			a.$ScaleSize = function (a, p, w) {
			  ...
			  e ||
				((e = o.Ch(n)),
				(f = n.parentNode),
				(c = { $Scale: o.q(n, v.qf, 1), $AutoCenter: o.q(n, v.yb) }),
				o.f(y, function (t, i) {
			  ...
			  i
				? ((b = s.l(a, p)),
				  t &&
					w >= 0 &&
					w < 1 &&
					((g = s.j(a, p)), (b = s.j(b / g, 1 / (1 - w)) * g)))
				: (k = d = b = s.B(pt < wt ? p : a, c.$Scale));
		  ...
		  function fo() {
			...
			l.call(
			  ...
			  -1,
			  2,
			  { $Easing: h.$Linear, Pc: { Pb: gf }, hc: w, $Reverse: pr },
			  t,
			  { Pb: 1 },
			  { Pb: -1 }
			);
		  ...
		  function oo(n, t) {
			...
			e.zc = function (n, t) {
			  ...
			  s
				? (i = y)
				: o && ((r = t / o), (i = a.$SlideEasing(r) * (v - h) + h));
			  i = te(i);
			  fi.L(i);
			};
		  ...
		  function ho(n, t) {
			...
			function ai() {
			  g == t &&
				k &&
				(k.S(), nt && nt.$Quit(), nt && nt.$Disable(), k.he());
			}
			function yi() {
			  g == t && k && k.S();
			}
			...
			function fi(n, t) {
			  var c, h, i, f, s, l, a;
			  if (
				(t || ((d = o.$FindChild(n, "bg")), (rt = d && o.Lb(d))),
				!o.g(n, fu) && (t || !d))
			  ) {
				  ...
				  ni ||
					...
					o.f(st, function (n) {
					  var t = o.g(n, "data-load") || "src",
						...
						r;
					  o.g(n, i) ||
						((r = o.hb(n, i) || o.hb(n, "src2")),
						r && (o.g(n, i, r), o.nb(n, o.g(n, "data-display"))));
					})),
				  o.Eh(st, v, o.Z(r, ui, n, f)))
				: ui(n, f);
			};
			h.Gg = function () {
			  var n, i, u;
		  ...
		  function le(n) {
			...
			if (ru()) {
			  ...
			  t = uu(t + u, 0.5);
			  i = s.P(t - r);
			  i < 1 && a.$SlideEasing != h.$Linear && (i = s.B(i, 0.5));
			  (vi && n) || !wu
				? r == t
				  ? lf.Bc()
				  : ot.se(r, t, i * br)
		  ...
		  function ye(n, r) {
			...
			of = sf;
			r
			  ? ((f = n.touches[0]), (dr = { x: f.clientX, y: f.clientY }))
			  : (dr = o.Tc(n));
			u = o.$EvtSrc(n);
			s = o.kb(u, "1", rf);
			(s && s !== d) ||
		  ...
		  function gu(n) {
			...
			if (
			  ...
			  n.type != "mousemove"
				? o.A(n.touches) == 1
				  ? ((i = n.touches[0]), (t = { x: i.clientX, y: i.clientY }))
				  : wi()
				: (t = o.Tc(n)),
			  t)
			) {
			  ...
			  (ut || e > 1.5 || h > 1.5) &&
				(kr
				  ...
				  : (s.G(fr) != fr && (ut = ut || ni & oi),
					...
					gt && ut && !nr && (o.$CancelEvent(n), ot.Ng(u), ot.Wg(wf))));
			}
		  }
		  function wi() {
			if (
		  ...
		  function pe(n) {
			...
			o.f(i, function (n) {
			  ...
			  r[n.tagName.toUpperCase()] &&
				!o.hb(n, "u") &&
				o.nb(n) != "none" &&
				(o.Jc(n, "flat"), o.rb(n, ei), ct.push(n));
			  o.N(t, (o.N(t) || 0) + 1);
			});
			w = o.A(ct);
			w &&
		  ...
		  i.F = function (n, r) {
			...
			ou &&
			  ki &&
			  ((ki.Yb = tr), (af = new ki.$Class(ou, ki, pt, wt)), si.push(af));
			ci &&
			  su &&
			  hu &&
			  ((ci.Yb = tr),
	...
	(function (n) {
	  ...
	  function e(n) {
		...
		try {
		  return (
			(n = decodeURIComponent(n.replace(o, " "))),
	  ...
	  n.removeCookie = function (t, i) {
		return n.cookie(t) === undefined
		  ? !1
		  : (n.cookie(t, "", n.extend({}, i, { expires: -1 })), !n.cookie(t));
	  };
	});
  !(function (n) {
	"object" == typeof module && "object" == typeof module.exports
	  ? n(require("jquery"), window, document)
	...
	var r = [],
	  ...
	  f = function () {
		for (var t = !1, n = r.length - 1; n >= 0; n--)
		  r[n].$blocker &&
			(r[n].$blocker.toggleClass("current", !t).toggleClass("behind", t),
			(t = !0));
	  };
	...
	(function (n, t) {
	  ...
	  var i = {
		...
		setup: function () {
		  ...
		  if (
			((this._toastEl =
			  this._toastEl || n("<div></div>", { class: "jq-toast-single" })),
			(t += '<span class="jq-toast-loader"></span>'),
			this.options.allowToastClose &&
			  (t += '<span class="close-jq-toast-single">&times;</span>'),
		...
		addToDom: function () {
		  ...
		  this.options.stack && !isNaN(parseInt(this.options.stack), 10)) &&
			((i = t.find(".jq-toast-single").length - this.options.stack),
			i > 0 &&
			  n(".jq-toast-wrap").find(".jq-toast-single").slice(0, i).remove());
		  this._container = t;
		},
		...
		animate: function () {
		  if (
			...
			t.setTimeout(function () {
			  "fade" === n.options.showHideTransition.toLowerCase()
				? (n._toastEl.trigger("beforeHide"),
				  n._toastEl.fadeOut(function () {
					n._toastEl.trigger("afterHidden");
				  }))
				: "slide" === n.options.showHideTransition.toLowerCase()
				? (n._toastEl.trigger("beforeHide"),
				  n._toastEl.slideUp(function () {
					n._toastEl.trigger("afterHidden");
				  }))
	  ...
	  i.extend(h.prototype, {
		...
		addContent: function (n) {
		  ...
		  i.each(u, function (n, r) {
			...
			"function" === i.type(u.opts.caption) &&
			  (u.opts.caption = u.opts.caption.apply(r, [t, u]));
			"function" === i.type(t.opts.caption) &&
			  (u.opts.caption = t.opts.caption.apply(r, [t, u]));
			u.opts.caption instanceof i ||
			  (u.opts.caption =
				void 0 === u.opts.caption ? "" : u.opts.caption + "");
			"ajax" === u.type &&
			  ((c = s.split(/\s+/, 2)),
			  c.length > 1 && ((u.src = c.shift()), (u.opts.filter = c.shift())));
			u.opts.modal &&
		  ...
		  Object.keys(t.slides).length &&
			(t.updateControls(),
			(r = t.Thumbs) && r.isActive && (r.create(), r.focus()));
		},
		addEvents: function () {
		  var t = this;
		  t.removeEvents();
		  ...
		  r.on("keydown.fb", function (n) {
			...
			return 9 == r
			  ...
			  : !u.opts.keyboard ||
				...
				n.altKey ||
				n.shiftKey ||
				i(n.target).is("input,textarea,video,audio,select")
			  ? void 0
			  : 8 === r || 27 === r
		...
		jumpTo: function (n, t) {
		  ...
		  if (!(r.isDragging || r.isClosing || (r.isAnimating && r.firstRun))) {
			if (
			  ((n = parseInt(n, 10)),
			  !(h = r.current ? r.current.opts.loop : r.opts.loop) &&
				(n < 0 || n >= l))
			)
			  return !1;
			if (
			  ...
			  (f = r.createSlide(n)),
			  l > 1 &&
				((h || f.index < l - 1) && r.createSlide(n + 1),
			  ...
			  i.isNumeric(t)
				? (f.forcedDuration = t)
				: (t = f.opts[s ? "animationDuration" : "transitionDuration"]),
			  (t = parseInt(t, 10)),
			  (a = r.isMoved(f)),
			  ...
			  return (
				f.opts.animationEffect &&
				  t &&
				  r.$refs.container.css("transition-duration", t + "ms"),
		...
		scaleToActual: function (n, t, r) {
		  ...
		  f.isAnimating ||
			...
			i.fancybox.animate(
			  p,
			  { top: s, left: o, scaleX: v, scaleY: y },
			  r || 366,
			  function () {
				f.isAnimating = !1;
			  }
		...
		getFitPos: function (n) {
		  ...
		  return (
			...
			(f -=
			  ...
			  parseFloat(e.css("marginTop")) +
			  parseFloat(e.css("marginBottom"))),
			(t && r) || ((t = u), (r = f)),
			...
			"image" === n.type
			  ? ((h.top =
				  Math.floor(0.5 * (f - r)) + parseFloat(o.css("paddingTop"))),
				(h.left =
				  Math.floor(0.5 * (u - t)) + parseFloat(o.css("paddingLeft"))))
			  : "video" === n.contentType &&
				((s =
				  n.opts.width && n.opts.height ? t / r : n.opts.ratio || 16 / 9),
		...
		updateSlide: function (n, t) {
		  ...
		  r.adjustCaption(n);
		  f &&
			(e || o || "video" === n.contentType) &&
			!n.hasError &&
			(i.fancybox.stop(f),
			i.fancybox.setTranslate(f, r.getFitPos(n)),
			n.pos === r.currPos && ((r.isAnimating = !1), r.updateCursor()));
		  r.adjustLayout(n);
		  u.length &&
			(u.trigger("refresh"),
			n.pos === r.currPos &&
			  r.$refs.toolbar
				.add(r.$refs.navigation.find(".fancybox-button--arrow_right"))
				.toggleClass(
		...
		isMoved: function (n) {
		  ...
		  return (
			!!u &&
			((r = i.fancybox.getTranslate(this.$refs.stage)),
			(t = i.fancybox.getTranslate(u.$slide)),
			!u.$slide.hasClass("fancybox-animated") &&
			  (Math.abs(t.top - r.top) > 0.5 || Math.abs(t.left - r.left) > 0.5))
		  );
		},
		...
		isScaledDown: function (n, t) {
		  ...
		  return (
			void 0 !== n && void 0 !== t
			  ? (r = n < u.width && t < u.height)
			  : f &&
				((r = i.fancybox.getTranslate(f)),
		  ...
		  return (
			"image" === r.type &&
			  ...
			  f &&
				u &&
				(u =
				  Math.abs(f.width - u.width) > 1.5 ||
				  Math.abs(f.height - u.height) > 1.5)),
			u
		  );
		},
		...
		setImage: function (n) {
		  ...
		  r.checkSrcset(n);
		  n.$content = i('<div class="fancybox-content"></div>')
			...
			.one("load", function () {
			  ...
			  r.isClosing ||
				(n.opts.srcset &&
				  ...
				  (t && "auto" !== t) ||
					(t =
					  (n.width / n.height > 1 && e.width() / e.height() > 1
						? "100"
		...
		setContent: function (n, t) {
		  ...
		  r.isClosing ||
			...
			n.$content.length ||
			  (n.$content = n.$slide.wrapInner("<div></div>").children().first()),
		...
		showLoading: function (n) {
		  ...
		  (n = n || t.current) &&
			!n.$spinner &&
			(n.$spinner = i(t.translate(t, t.opts.spinnerTpl))
			  .appendTo(n.$slide)
			  .hide()
			  .fadeIn("fast"));
		},
		hideLoading: function (n) {
		  ...
		  (n = n || t.current) &&
			n.$spinner &&
			(n.$spinner.stop().remove(), delete n.$spinner);
		},
		afterLoad: function (n) {
		  ...
		  t.isClosing ||
			...
			!n.opts.smallBtn ||
			  ...
			  (n.$smallBtn = i(t.translate(n, n.opts.btnTpl.smallBtn)).appendTo(
				n.$content
			  )),
			n.opts.protect &&
			  n.$content &&
			  ...
			  "image" === n.type &&
				i('<div class="fancybox-spaceball"></div>').appendTo(n.$content)),
			t.adjustCaption(n),
			t.adjustLayout(n),
		...
		revealContent: function (n) {
		  ...
		  return (
			...
			(f = parseInt(
			  void 0 === n.forcedDuration ? f : n.forcedDuration,
			  10
			)),
			...
			"zoom" === r
			  ? ((t.isAnimating = !0),
				...
				"auto" == h &&
				  (h = Math.abs(n.width / n.height - o.width / o.height) > 0.1),
		  ...
		  !n.isMoved() &&
			...
			(t.isComplete ||
			  ...
			  i.each(n.slides, function (t, r) {
				r.pos >= n.currPos - 1 && r.pos <= n.currPos + 1
				  ? (f[r.pos] = r)
			...
			t.opts.autoFocus &&
			  "html" === t.contentType &&
			  ((r = t.$content.find("input[autofocus]:enabled:visible:first")),
			  ...
			  : (r.removeEvents(),
				...
				"zoom" === o
				  ? (i.fancybox.stop(h),
					...
					"auto" == a &&
					  (a =
						Math.abs(f.width / f.height - e.width / e.height) > 0.1),
					a && (e.opacity = 0),
		...
		updateControls: function () {
		  ...
		  e && e.length
			? ((n.$caption = o), o.children().eq(0).html(e))
			: (n.$caption = null);
		  ...
		  if (n && t)
			return (
			  (void 0 === t.left && void 0 === t.top) ||
				((i =
				  (void 0 === t.left ? n.position().left : t.left) +
				  "px, " +
				  (void 0 === t.top ? n.position().top : t.top) +
				  "px"),
				(i = this.use3d
				  ? "translate3d(" + i + ", 0px)"
				  : "translate(" + i + ")")),
		...
		return (
		  ...
		  t
			? i("body")
				...
				.on("click.fb-start", t, { options: n }, s)
	...
	(function (n) {
	  ...
	  n(document).on("objectNeedsType.fb", function (i, u, f) {
		...
		n.each(v, function (i, r) {
		  ...
		  if ((s = o.match(r.matcher))) {
			if (
			  ((h = r.type), (l = i), (a = {}), r.paramPlace && s[r.paramPlace])
			)
			  for (
				e = s[r.paramPlace],
				  "?" == e[0] && (e = e.substring(1)),
			...
			return (
			  ...
			  (o =
				"function" === n.type(r.url)
				  ? r.url.call(this, s, c, f)
				  : t(r.url, s, c)),
			  (y =
				"function" === n.type(r.thumb)
				  ? r.thumb.call(this, s, c, f)
				  : t(r.thumb, s)),
			  "youtube" === i
				? (o = o.replace(/&t=((\d+)m)?(\d+)s/, function (n, t, i, r) {
					return (
					  "&start=" +
					  ((i ? 60 * parseInt(i, 10) : 0) + parseInt(r, 10))
					);
				  }))
	  ...
	  n(document).on({
		"afterShow.fb": function (n, t, r) {
		  t.group.length > 1 &&
			("youtube" === r.contentSource || "vimeo" === r.contentSource) &&
			i.load(r.contentSource);
		},
	  });
	})(jQuery),
	(function (n, t, i) {
		...
		if (
		  ...
		  f.startPoints.length &&
			...
			(((f.opts || f.canPan) &&
			  ...
			  i.fancybox.isMobile && o.parents(".fancybox-caption").length)) &&
			  ((f.isScrollable = h(o) || h(o.parent())),
			  (i.fancybox.isMobile && f.isScrollable) || r.preventDefault(),
			  (1 === f.startPoints.length || c.hasError) &&
				(f.canPan
				  ? (i.fancybox.stop(f.$content), (f.isPanning = !0))
				  : (f.isSwiping = !0),
			  ...
			  2 === f.startPoints.length &&
				...
				(f.centerPointStartX =
				  0.5 * (f.startPoints[0].x + f.startPoints[1].x) -
				  i(n).scrollLeft()),
				(f.centerPointStartY =
				  0.5 * (f.startPoints[0].y + f.startPoints[1].y) -
				  i(n).scrollTop()),
		...
		if (!0 !== s)
		  "x" == s &&
			...
			(t.instance.group.length < 2 ||
			  (0 === t.instance.current.index && !t.instance.current.opts.loop))
			  ? (u += Math.pow(t.distanceX, 0.8))
			  : t.distanceX < 0 &&
				(t.instance.group.length < 2 ||
				  (t.instance.current.index === t.instance.group.length - 1 &&
		  ...
		  if (
			...
			r.group.length < 2 && t.opts.vertical
			  ...
			  : r.isDragging ||
				!1 === t.opts.vertical ||
				("auto" === t.opts.vertical && i(n).width() > 800)
			  ? (t.isSwiping = "x")
			  : ((e = Math.abs(
				  (180 * Math.atan2(t.distanceY, t.distanceX)) / Math.PI
				)),
		  ...
		  i.each(r.slides, function (n, u) {
			...
			u.pos === r.current.pos &&
			  ((t.sliderStartPos.top = f.top - e.top),
	  ...
	  r.prototype.endPanning = function () {
		var r,
		  ...
		  n = this;
		n.contentLastPos &&
		  (!1 === n.opts.momentum || n.dMs > 350
			? ((r = n.contentLastPos.left), (u = n.contentLastPos.top))
			: ((r = n.contentLastPos.left + 500 * n.velocityX),
				...
				case "zoom":
				  "image" == o.type &&
					...
					(r.canPan()
					  ...
					  : r.isScaledDown()
					  ? r.scaleToActual(c, l)
					  : r.group.length < 2 && r.close(u.startEvent));
			  }
		  };
		if (
	  ...
	  t.extend(i.prototype, {
		...
		init: function () {
		  ...
		  i.group.length < 2 || !r
			? n.$button.hide()
			: r.progress &&
			  (n.$progress = t('<div class="fancybox-progress"></div>').appendTo(
				i.$refs.inner
			  ));
		},
		set: function (n) {
	...
	(function (n, t) {
	  ...
	  t.extend(r.prototype, {
		...
		focus: function (n) {
		  ...
		  i.instance.current &&
			...
			(t = u.position()),
			"y" === i.opts.axis &&
			(t.top < 0 || t.top > r.height() - u.outerHeight())
			  ? r.stop().animate({ scrollTop: r.scrollTop() + t.top }, n)
			  : "x" === i.opts.axis &&
				(t.left < f.scrollLeft() ||
				  t.left > f.scrollLeft() + (f.width() - u.outerWidth())) &&
	  ...
	  t(n).on({
		"onInit.fb": function (n, t) {
		  ...
		  t &&
			!t.Thumbs &&
			((i = new r(t)), i.isActive && !0 === i.opts.autoStart && i.show());
		},
		"beforeShow.fb": function (n, t, i, r) {
		  var u = t && t.Thumbs;
	...
	(function (n, t) {
	  ...
	  t(n).on("click", "[data-fancybox-share]", function () {
		var u,
		  ...
		  n = r.current || null;
		n &&
		  ("function" === t.type(n.opts.share.url) &&
		  ...
		  i(n).on("hashchange.fb", function () {
			...
			t
			  ? t.currentHash === n.gallery + "-" + n.index ||
				(1 === n.index && t.currentHash == n.gallery) ||
	  ...
	  i.prototype = {
		...
		onBlur: function () {
		  ...
		  t.blurTimeoutId = setTimeout(function () {
			...
			t.selection &&
			  t.currentValue !== u &&
			  (i.onInvalidateSelection || n.noop).call(t.element);
		  }, 200);
		  n(".search-bg").hide();
		...
		abortAjax: function () {
		  var n = this;
		  n.currentRequest &&
			(n.currentRequest.abort(), (n.currentRequest = null));
		},
		  ...
		  if (!i.disabled && i.visible) {
			switch (n.which) {
			  ...
			  case t.TAB:
				...
				if ((i.select(i.selectedIndex), i.options.tabDisabled === !1))
				  return;
				break;
			  case t.RETURN:
				if (i.selectedIndex === -1) {
		...
		onKeyUp: function (n) {
		  ...
		  if (!i.disabled) {
			...
			i.currentValue !== i.el.val() &&
			  (i.findBestHint(),
			  i.options.deferRequestBy > 0
				? (i.onChangeTimeout = setTimeout(function () {
					i.onValueChange();
				  }, i.options.deferRequestBy))
				: i.onValueChange());
		  }
		},
		...
		getSuggestionsLocal: function (t) {
		  ...
		  return (
			...
			u &&
			  i.suggestions.length > u &&
			  (i.suggestions = i.suggestions.slice(0, u)),
			i
		  );
		},
		getSuggestions: function (t) {
		  ...
		  if (
			...
			if (
			  ((e = r.ignoreParams ? null : r.params), n.isFunction(r.lookup))
			) {
			...
			i.isLocal
			  ? (u = i.getSuggestionsLocal(t))
			  : (n.isFunction(f) && (f = f.call(i.element, t)),
				(o = f + "?" + n.param(e || {})),
				(u = i.cachedResponse[o]));
			u && Array.isArray(u.suggestions)
			  ? ((i.suggestions = u.suggestions),
				i.suggest(),
				r.onSearchComplete.call(i.element, t, u.suggestions))
			  : i.isBadQuery(t)
			  ? r.onSearchComplete.call(i.element, t, [])
			  : (i.abortAjax(),
				(s = { url: f, data: e, type: r.type, dataType: r.dataType }),
		...
		hide: function () {
		  var t = this,
			i = n(t.suggestionsContainer);
		  n.isFunction(t.options.onHide) &&
			t.visible &&
			t.options.onHide.call(t.element, i);
		  t.visible = !1;
		  t.selectedIndex = -1;
		  clearTimeout(t.onChangeTimeout);
		...
		suggest: function () {
		  ...
		  (r.includes("samsung") ||
			...
			r.includes("s22")) &&
			(e +=
			  '<div class="samsung-landing"><a href="/samsung"><img src="/Content/samsung/logo_samsung.png"/> <strong>Chuyên trang Samsung</strong></a></div>');
		  n.each(t.suggestions, function (n, t) {
			s && (e += p(t, i, n));
			e +=
			  '<div onMouseDown="return false;" class="' +
			  h +
			  '" data-index="' +
			  n +
			  '">' +
		  ...
		  l &&
			f.append(
			  '<p class="more-results"><a href="' +
				l +
				i +
				'">Hiển thị kết quả cho <strong><i>' +
				i +
				"</i></strong></a></p>"
			);
		  t.fixPosition();
		...
		adjustContainerWidth: function () {
		  ...
		  r.width === "auto"
			? ((i = t.el.outerWidth()), u.css("width", i > 0 ? i : 300))
			: r.width === "flex" && u.css("width", "");
		},
		...
		signalHint: function (t) {
		  ...
		  i.hintValue !== r &&
			((i.hintValue = r), (i.hint = t), (this.options.onHint || n.noop)(r));
		},
		verifySuggestionsFormat: function (t) {
		  return t.length && typeof t[0] == "string"
			? n.map(t, function (n) {
				return { value: n, data: null };
			  })
			: t;
		},
		...
		moveDown: function () {
		  var n = this;
		  n.selectedIndex !== n.suggestions.length - 1 &&
			n.adjustScroll(n.selectedIndex + 1);
		},
		adjustScroll: function (t) {
		  ...
		  u &&
			...
			r < f
			  ? n(i.suggestionsContainer).scrollTop(r)
			  : r > o &&
				n(i.suggestionsContainer).scrollTop(r - i.options.maxHeight + e),
			i.options.preserveInput ||
			  ((i.ignoreValueChange = !0),
		...
		getValue: function (n) {
		  var r = this,
			...
			i;
		  return u
			? ((t = r.currentValue), (i = t.split(u)), i.length === 1)
			  ? n
			  : t.substr(0, t.length - i[i.length - 1].length) + n
			: n;
		},
		dispose: function () {
		  var t = this;
		...
		return arguments.length
		  ? this.each(function () {
			  var e = n(this),
				f = e.data(u);
			  typeof t == "string"
				? f && typeof f[t] == "function" && f[t](r)
				: (f && f.dispose && f.dispose(),
				  (f = new i(this, t)),
				  e.data(u, f));
			})
		  : this.first().data(u);
	...
	(function (n) {
	  ...
	  n.fn.textHeight = function () {
		var t = n("<span>" + n(this).html() + "</span>"),
		  i;
		return (
		  t.css("font-size", n(this).css("font-size")).hide(),
		  t.prependTo("body"),
		  (i = t.height()),
		  t.remove(),
		  i
	  ...
	  String.fromCodePoint = function () {
		for (
		  var n, t = Array.prototype.slice.call(arguments), i = t.length;
		  i-- > 0;
		...
		if (typeof i == "string") {
		  ...
		  return (
			this.each(function () {
			  ...
			  f instanceof t &&
				typeof f[i] == "function" &&
				(r = f[i].apply(f, Array.prototype.slice.call(u, 1)));
	  ...
	  t.prototype.build = function () {
		...
		n(this.element).attr("data-rate-value") &&
		  (this.value = n(this.element).attr("data-rate-value"));
		i = (this.value / this.settings.max_value) * 100;
		typeof this.settings.symbols[this.settings.selected_symbol_type] ==
		  "string" &&
		  ((t = this.settings.symbols[this.settings.selected_symbol_type]),
		...
		this.settings.hasOwnProperty("update_input_field_name") &&
		  this.settings.update_input_field_name.val(this.value);
	  };
	  t.prototype.addLayer = function (t, i, r, u) {
		for (var f, o = "<div>", e = 0; e < this.settings.max_value; e++)
		  Array.isArray(r)
			? (this.settings.convert_to_utf8 &&
				(r[e] = String.fromCodePoint(r[e])),
			  (o += "<span>" + r[e] + "</span>"))
			: (this.settings.convert_to_utf8 && (r = String.fromCodePoint(r)),
			  (o += "<span>" + r + "</span>"));
		return (
		  (o += "</div>"),
		  (f = n(o)
	  ...
	  t.prototype.hover = function (t) {
		...
		this.raise_select_layer ||
		  ...
		  this.settings.only_select_one_symbol
			...
			: this.layers.hover_layer.css({ width: u + "%", display: "block" }));
	  };
	  ...
	  t.prototype.toValue = function (n, t) {
		...
		return (
		  (i = t
			? (n / this.layers.base_layer.textWidth()) * this.settings.max_value
			: (n / 100) * this.settings.max_value),
		  (r = i / this.settings.step_size),
		  r - Math.floor(r) < 5e-5 &&
			(i =
			  Math.round(i / this.settings.step_size) * this.settings.step_size),
	  ...
	  t.prototype.setValue = function (t) {
		...
		if (!this.settings.readonly) {
		  if (
			(t < 0
			  ? (t = 0)
			  : t > this.settings.max_value && (t = this.settings.max_value),
			(u = this.getValue()),
			(this.value = t),
			(e = n(this.element).trigger("change", { from: u, to: this.value })),
			n(this.element).find(".rate-face").remove(),
			n(this.element).find("span").css({ visibility: "visible" }),
			...
			var o = "<div>" + this.set_faces[i] + "</div>",
			  ...
			  c =
				f.textWidth() * (i - 1) + (f.textWidth() - n(o).textWidth()) / 2;
			n(o)
			  .appendTo(this.element)
			  .css({ display: "inline-block", position: "absolute", left: c })
			  .addClass("rate-face");
		  ...
		  this.settings.only_select_one_symbol
			? ((r = this.toWidth(this.settings.max_value)),
	...
	(function (n, t) {
	  ...
	  return (
		...
		(n.configure = function (n) {
		  var i, r;
		  for (i in n)
			(r = n[i]), r !== undefined && n.hasOwnProperty(i) && (t[i] = r);
		  return this;
		}),
		(n.status = null),
		(n.set = function (r) {
		...
		(n.done = function (t) {
		  return !t && !n.status ? this : n.inc(0.3 + 0.5 * Math.random()).set(1);
		}),
		(n.inc = function (t) {
		  var i = n.status;
		  return i
		...
		(n.render = function (u) {
		  ...
		  return (
			...
			t.showSpinner ||
			  ((s = f.querySelector(t.spinnerSelector)), s && h(s)),
		...
		(i = (function () {
		  ...
		  return function (t, i) {
			...
			if (u.length == 2)
			  for (r in i)
				(f = i[r]), f !== undefined && i.hasOwnProperty(r) && n(t, r, f);
			else n(t, u[1], u[2]);
		  };
		})()),
		n
	...
	(function (n, t, i) {
	  function u(t, r) {
		function v() {
		  ...
		  u.targ.css({ position: "absolute", margin: 0 });
		  l(!1);
		}
		function o() {
		  u.opts.autoplay && c();
		...
		function c() {
		  u.timer == 0 &&
			...
			n(u.opts.controls.toggle)
			  .addClass("et-run")
			  .html(u.opts.controls.stopText));
		}
		function e() {
		...
		function h(n) {
		  ...
		  u.moving ||
			(u.elem.is(":visible") &&
			  (n == "up"
				? ((i = ":first-child"), (r = "-="), (f = "appendTo"))
				: ((i = ":last-child"), (r = "+="), (f = "prependTo")),
			  (t = u.targ.children(i)),
			  (e = t.outerHeight()),
			  typeof u.opts.callbacks.before == "function" &&
				u.opts.callbacks.before.call(u, u.targ, t),
			  (u.moving = !0),
			  u.targ
				.stop(!0, !0)
				.animate(
				  ...
				  function () {
					...
					l(!0);
					u.moving = !1;
					typeof u.opts.callbacks.after == "function" &&
					  u.opts.callbacks.after.call(u, u.targ, t);
				  }
				)));
		}
		function s(n) {
		...
		function p(t) {
		  ...
		  t
			? u.elem
				.stop(!0, !0)
				.animate({ height: i }, u.opts.speed, function () {
				  a();
				})
			: u.elem.css("height", i);
		}
		...
		function w() {
		  ...
		  typeof i.hidden != "undefined"
			? ((n = "hidden"), (t = "visibilitychange"))
			: typeof i.msHidden != "undefined"
			? ((n = "msHidden"), (t = "msvisibilitychange"))
			: typeof i.webkitHidden != "undefined" &&
			  ((n = "webkitHidden"), (t = "webkitvisibilitychange"));
		  i.addEventListener(
			t,
			function () {
			  i[n] ? e() : o();
		...
		function a() {
		  typeof u.opts.callbacks.finish == "function" &&
			u.opts.callbacks.finish.call(u, u.targ);
		}
		var u = this;
		if (
		  ((u.opts = n.extend({}, f, r)),
  ...
  $(document).ready(function () {
	$(".ticker").easyTicker({ direction: "up", visible: 1, interval: 5e3 });
	$(".equaHeight").each(function (n, t) {
	  var i = $(this).attr("data-obj"),
		r;
	  i != "" && i != undefined
  ...
  setProductContentHeighWithSpecs = function () {
	...
	$("#viewMoreContent").click(function () {
	  ...
	  $(this).text(n);
	  n == "Thu gọn"
		? $("#productContent").css({ height: "auto", overflow: "auto" })
		: $("#productContent").css({ height: specsHeight, overflow: "hidden" });
	});
  };
  ...
  $(document).ready(function () {
	...
	$(".ajax-modal").click(function (n) {
	  ...
	  var t =
		  $(this).attr("data-width") != null ? $(this).attr("data-width") : "",
		i =
		  $(this).attr("data-padding") != null
  ...
  sliderContent_init = function () {
	...
	if (i) {
	  ...
	  function i() {
		...
		t
		  ? ((t = Math.min(t, 1200)), n.$ScaleWidth(t))
  ...
  imagePreview_init = function () {
	...
	$("#colorOptions > div").click(function () {
	  ...
	  $("#dfSKU").html(t);
	  $(".check-stock .city ul li.instock")
		.not(".selected")
		.removeClass("instock")
		.addClass("outstock");
	  $(".check-stock .city ul li[data-sku*='" + t + "']")
		.removeClass("outstock")
		.addClass("instock");
	  $(".check-stock .store ul li").removeClass("instock").addClass("outstock");
	  $(".check-stock .store ul li[data-sku*='" + t + "']")
		.removeClass("outstock")
		.addClass("instock");
	  outStockMessage();
